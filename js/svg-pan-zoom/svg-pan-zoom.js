...
ShadowViewport.prototype.init = function(viewport, options) {
  ...
  // ViewBox
  this.viewBox = {x: 0, y: 0, width: 200, height: 200}
  this.cacheViewBox()
 ...
 * Set pan and zoom to initial state
 */
SvgPanZoom.prototype.setAsDefault = function() {
  var currentState = this.viewport.getState();
  this.viewport.originalState = {
...
SvgPanZoom.prototype.getPublicInstance = function() {
  ...
  if (!this.publicInstance) {
    ...
    , setAsDefault: function() { that.setAsDefault(); return this.pi}
